...
const modulesData = ref([
  {
    ...
    rows: [
      [
        ...
        { name: "二维可视化", link: "/4.基础使用指南/可视化/二维可视化.html" }
      ],
      [
        { name: "仿真平台", link: null },
        { name: "三维可视化", link: "/4.基础使用指南/可视化/三维可视化.html" }
      ],
      [
        { name: "对象管理", link: "/4.基础使用指南/2-插入对象/" },
        { name: "矢量几何", link: "/5.专业使用指南/17-矢量几何工具.html" }
      ],
      [
        { name: "图文报告", link: "/4.基础使用指南/0-ATK工作区介绍/01-菜单栏介绍/05-输出.html" },
        { name: "模型管理", link: null }
      ]
    ]
  },
  {
    ...
    rows: [
      [
        { name: "可见性分析", link: "/5.专业使用指南/1-可见性工具.html" },
        { name: "区域覆盖", link: "/5.专业使用指南/9-区域覆盖模块.html" }
      ],
      [
        { name: "覆盖分析", link: "/5.专业使用指南/2-覆盖工具.html" },
        { name: "通信链路", link: null }
      ]
    ]
  },
  {
    ...
    rows: [
      [
        { name: "接近分析", link: "/5.专业使用指南/5-接近分析工具.html" },
        { name: "批量坐标转换", link: "/5.专业使用指南/4-批量坐标转换工具.html" }
      ],
      [
      ...
      [
        ...
        { name: "寿命预报", link: "/5.专业使用指南/16-寿命预报模块.html" }
      ],
      [
        { name: "碰撞规避", link: "/5.专业使用指南/6-碰撞规避工具.html" },
        { name: "卫星系统", link: "/4.基础使用指南/2-插入对象/10-对象属性/卫星系统.html" }
      ]
    ]
  },
  {
    ...
    rows: [
      [
        { name: "机动规划", link: "/5.专业使用指南/3-轨道机动规划工具/" },
        { name: "高级星座", link: "/5.专业使用指南/11-高级星座设计功能模块.html" }
      ],
      [
        { name: "RPO工具", link: "/5.专业使用指南/13-RPO功能模块.html" },
        { name: "巨型星座", link: "/5.专业使用指南/10-巨型星座设计模块.html" }
      ],
      [
        { name: "星座设计", link: "/5.专业使用指南/7-星座设计工具.html" }
      ]
    ]
  },
  {
