...
const modulesData = ref([
  {
    ...
    rows: [
      [
        ...
        { name: "二维可视化", link: "/03-基础使用指南/可视化/坐标系向量.html" }
      ],
      [
        { name: "仿真平台", link: null },
        { name: "三维可视化", link: "/03-基础使用指南/可视化/客户端绘图.html" }
      ],
      [
      ...
      [
        { name: "图文报告", link: "/03-基础使用指南/01-界面总览/01-主菜单栏/05-输出.html" },
        { name: "模型管理", link: null }
      ]
    ]
  },
  ...
  },
  {
    ...
    rows: [
      ...
      [
        ...
        { name: "卫星系统", link: "/03-基础使用指南/03-对象管理/10-对象属性/卫星系统.html" }
      ]
    ]
  },
  {
