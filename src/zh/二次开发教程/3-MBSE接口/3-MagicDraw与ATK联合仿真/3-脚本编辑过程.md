...
![编辑 ATK 脚本](./media/3-脚本编辑过程/image9.png)

## 编写 ATK 脚本

在 **ATK 脚本编辑器** 中填写 ATK 脚本，实现联合仿真，如下图所示：

![ATK 脚本编辑器](./media/3-脚本编辑过程/image10.png)
...
![新建属性](./media/3-脚本编辑过程/image11.png)

### 步骤二：修改构造型

将属性的 **Stereotype**（构造型）修改为 `ValueProperty`，如下图所示：

![修改 Stereotype 为 ValueProperty](./media/3-脚本编辑过程/image12.png)
...
![修改属性 Type](./media/3-脚本编辑过程/image13.png)

### 步骤四：给输入属性赋初值

为输入属性设置初始值，如下图所示：

![给输入属性赋初值](./media/3-脚本编辑过程/image14.png)
