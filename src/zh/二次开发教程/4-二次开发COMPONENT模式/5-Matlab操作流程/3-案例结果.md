...
![生成的想定与数据报告](media/3-案例结果/生成的想定与数据报告_zy.png)

打开ATK检查生成的想定文件，选择轨道快速转移想定文件“FastTransfer.xml”，点击“开始”按钮运行动画，拉动下方时间轴查看二维视图下的轨迹效果，如图所示。

![ATK二维视图下的轨道快速转移效果图](media/3-案例结果/ATK二维视图下的轨道快速转移效果图_zy.png)

点击ATK“三维视图”按钮切换至三维视图，查看三维效果，如图所示。

![ATK三维视图下的轨道快速转移效果图](media/3-案例结果/ATK三维视图下的轨道快速转移效果图_zy.png)