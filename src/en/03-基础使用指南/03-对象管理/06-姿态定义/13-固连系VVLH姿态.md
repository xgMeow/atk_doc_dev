...
![Attitude](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/13-固连系VVLH姿态/image.png)

### Configuring Parameters

**Constraint Offset**: Fixed offset from the reference attitude.

![Configure Parameters](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/13-固连系VVLH姿态/image-1.png)
...
![Attitude Report](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/13-固连系VVLH姿态/image-2.png)
