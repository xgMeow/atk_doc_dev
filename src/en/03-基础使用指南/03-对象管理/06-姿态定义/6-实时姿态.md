...
![Select Attitude](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/6-实时姿态/image.png)
...
![Configure Parameters](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/6-实时姿态/image-1.png)

### Connect Commands

Use Connect commands to configure parameters and write real-time data.

![Connect Commands](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/6-实时姿态/image-2.png)
...
![RealTime Mode](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/6-实时姿态/image-4.png)