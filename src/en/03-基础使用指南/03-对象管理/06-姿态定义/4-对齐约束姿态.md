...
![Select Attitude](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/4-对齐约束姿态/image.png)
...
![Configure Parameters](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/4-对齐约束姿态/image-1.png)
...
![Attitude Report](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/4-对齐约束姿态/image-2.png)
...
![Select Vectors](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/4-对齐约束姿态/image-9.png)

6. **Vector Configuration**

Check **Show** and click **Apply** or **OK**.

![Vector Configuration](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/4-对齐约束姿态/image-10.png)
...
![3D Visualization](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/4-对齐约束姿态/image-11.png)