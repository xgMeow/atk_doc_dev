...
![Select Attitude](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image.png)

### Configuring Parameters

**Target**: The target point to which the attitude points.

![Configure Parameters](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-2.png)
...
![Attitude Report](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-3.png)
...
![Add Vector Geometry Vector](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-4.png)

2. **Add a Displacement Vector**

Click **Select**, choose **VectorDisplacement**, and click **OK**.

![Add Displacement Vector](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-5.png)
...
![Configure Displacement Vector](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-6.png)
...
![Select Vector](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-7.png)

9. **Vector Configuration**

Check **Show** and click **Apply** or **OK**.

![Vector Configuration](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-8.png)
...
![3D View](../../../../zh/03-基础使用指南/03-对象管理/07-姿态定义/media/10-目标指向姿态/image-9.png)