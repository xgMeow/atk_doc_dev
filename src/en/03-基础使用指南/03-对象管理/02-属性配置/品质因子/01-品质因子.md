...
Figures of Merit are applicable to both the [Coverage Tool](../../../../5.专业使用指南/01-可见性与覆盖分析/02-覆盖性工具.md) and the [Regional Coverage Tool](../../../../5.专业使用指南/01-可见性与覆盖分析/03-区域覆盖分析.md).
...
![Figure of Merit Master Control](../../../../../zh/03-基础使用指南/03-对象管理/02-属性配置/品质因子/media/基本属性/image0712-1.png)
...
0 is opaque, 100 is fully transparent. The text box and slider are linked.
    ...
    ![Grid Point Translucency Settings](../../../../../zh/03-基础使用指南/03-对象管理/02-属性配置/品质因子/media/基本属性/image0712-2.png)
...
- **Legend**: Click the <kbd>Legend…</kbd> button to open the **Figure of Merit Legend Layout** dialog. You can set display position, background color, and other parameters for 2D and 3D views.  
  ...
  **Range Color Options**: You can set the color order, number of rows/columns, and color square width/height.
  ...
  ![Figure of Merit Legend Layout](../../../../../zh/03-基础使用指南/03-对象管理/02-属性配置/品质因子/media/基本属性/image0712-3.png)
