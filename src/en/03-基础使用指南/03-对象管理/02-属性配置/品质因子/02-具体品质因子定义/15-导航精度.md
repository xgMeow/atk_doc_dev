...
- **Method 1**: Select the target object → Enter the [Coverage Analysis] page → Click <kbd>Define...</kbd> in the [Figure of Merit] area.
  ...
  ![Coverage Analysis Entry](../../../../../../zh/03-基础使用指南/03-对象管理/02-属性配置/品质因子/01-基本定义/media/导航精度/image.png)

- **Method 2**: Right-click the [Figure of Merit] object in the left object tree → Select <kbd>Properties</kbd>.

  ![Figure of Merit Object](../../../../../../zh/03-基础使用指南/03-对象管理/02-属性配置/品质因子/01-基本定义/media/导航精度/image1.png)
...
![Figure of Merit Configuration](../../../../../../zh/03-基础使用指南/03-对象管理/02-属性配置/品质因子/01-基本定义/media/导航精度/image123.png)
