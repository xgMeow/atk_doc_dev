---
description: A complete usage example of the Matlab SDK — an orbital inclination change scenario, covering the full workflow code for connecting, creating a new scenario, building three groups of maneuver/target sequences, running the simulation, saving and disconnecting.
---
...
```matlab
% ============================================================
% 0. Add the Matlab communication library to the search path
% ============================================================
...
- Before you start, make sure you have completed [Environment Configuration](./1-简介与配置.md#configuration-steps): add the Matlab communication library path with `addpath`
...
Copy the complete code above and save it as an `.m` file (for example, `inclination_change.m`), then open it in Matlab and click <kbd>Run</kbd>.
...
![Scenario simulation interface](../../../../../../zh/二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/2-Matlab/media/3-完整示例/image0108-17.png)
...
![Satellite properties interface](../../../../../../zh/二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/2-Matlab/media/3-完整示例/image0108-13.png)
