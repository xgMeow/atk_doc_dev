...
![场景仿真界面](../../../../../../zh/二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/1-Python/media/1-操作流程/场景仿真界面.png)

可在 ATK 中右键点击卫星对象，选择**属性**查看代码设置的各项参数是否正确生效：

![卫星属性界面](../../../../../../zh/二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/1-Python/media/3-完整示例/image-20260701101417437.png)
