...
![使用文件目录](../../../../../../zh/二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/1-Python/media/README/image0120-1.png)

### 配置步骤

1. 将 <PathCopy :entry="pythonDir" label="Python" /> 文件夹中的 `ATKConnectModule.py` 和 `_ATKConnectModule.pyd` 复制到你的 Python 项目工作目录

![将库文件复制到使用目录](../../../../../../zh/二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/1-Python/media/1-操作流程/image0120-2.png)
