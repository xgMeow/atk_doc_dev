...
![依赖文件](../../../../zh/二次开发教程/4-二次开发COMPONENT模式/4-Python操作流程/media/1-案例介绍/依赖文件.png)

![嵌入式Python解释器文件](../../../../zh/二次开发教程/4-二次开发COMPONENT模式/4-Python操作流程/media/1-案例介绍/嵌入式Python解释器文件.png)