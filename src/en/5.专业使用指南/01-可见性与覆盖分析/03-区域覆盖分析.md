...
- **Figure of Merit Results**: Describe statistical results of coverage quality metrics, such as FOM maximum, minimum, mean, percentage of satisfied area, etc. For details on FOM types and statistics, see [Figure of Merit](../../03-基础使用指南/03-对象管理/02-属性配置/品质因子/).
...
For detailed definitions, property configurations, and statistical descriptions of Figures of Merit, see [Figure of Merit](../../03-基础使用指南/03-对象管理/02-属性配置/品质因子/).
:::
