...
- **Method 1**: Select the target object → Enter the [Coverage Analysis] page → Click <kbd>Define...</kbd> in the [Figure of Merit] area.
  ...
  ![Coverage Analysis Entry](../../../../../zh/5.专业使用指南/01-可见性与覆盖分析/04-品质因子/02-具体品质因子定义/media/导航精度/image.png)

- **Method 2**: Right-click the [Figure of Merit] object in the left object tree → Select <kbd>Properties</kbd>.

  ![Figure of Merit Object](../../../../../zh/5.专业使用指南/01-可见性与覆盖分析/04-品质因子/02-具体品质因子定义/media/导航精度/image1.png)
...
![Figure of Merit Configuration](../../../../../zh/5.专业使用指南/01-可见性与覆盖分析/04-品质因子/02-具体品质因子定义/media/导航精度/image123.png)
