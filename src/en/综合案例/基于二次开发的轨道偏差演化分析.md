...
![地月空间轨道偏差演化示意图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image01-地月空间轨道偏差演化示意图.png)
...
- [ATK 二次开发配置](../二次开发教程/2-二次开发CONNECT模式/1-开发方式/4-语言SDK/2-Matlab/README.md)
...
![J2000坐标系飞行轨迹图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image05-J2000坐标系飞行轨迹图.png)
...
![保存当前想定窗口](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image06-保存当前想定窗口.png)
...
![蒙特卡洛仿真思路流程图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image07-蒙特卡洛仿真思路流程图.png)
...
![断点查看样本点卫星运行轨迹](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image08-断点查看样本点卫星运行轨迹.png)

运行至断点后，可在 ATK 三维视图中查看该组样本点对应的蒙特卡洛仿真过程，卫星的飞行轨迹在不同初始导航误差的情况下呈现出明显的差异，第一组样本点地心 J2000 坐标系下的飞行轨迹在 ATK 三维视图中如下所示。

![ATK三维视图第一组样本飞行轨迹](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image09-ATK三维视图第一组样本飞行轨迹.png)
...
![三阶段偏差结果数据图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image10-三阶段偏差结果数据图.png)
...
![出发后两天终端位置偏差三维散点图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image11-出发后两天终端位置偏差三维散点图.png)

![出发后两天终端位置三维散点图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image12-出发后两天终端位置三维散点图.png)

可以看到，在预报 2 天的情况下，偏差演化情况仍基本保持高斯分布特性，$3\sigma$ 误差椭球能够很好描述误差的分布情况。

近月点时刻，即 "7 Apr 2033 05:48:14.88"，观察偏差的演化情况如下所示。

![近月点终端位置偏差三维散点图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image13-近月点终端位置偏差三维散点图.png)

![近月点终端位置三维散点图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image14-近月点终端位置三维散点图.png)

可以看到，在预报到近月点的情况下，偏差演化已经初现非高斯分布特性，发生了变形，$3\sigma$ 误差椭球虽能包含绝大多数样本点，但已不能完整表征其分布特性。

进一步预报到返回近地点时刻，终端偏差在三维空间的分布以及终端位置的分布情况如下。

![返回近地点终端位置偏差三维散点图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image15-返回近地点终端位置偏差三维散点图.png)

![返回近地点终端位置三维散点图](../../zh/综合案例/media/基于二次开发的轨道偏差演化分析/image16-返回近地点终端位置三维散点图.png)
