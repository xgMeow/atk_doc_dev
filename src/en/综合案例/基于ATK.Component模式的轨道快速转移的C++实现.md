...
![案例生成文件](../../zh/综合案例/media/轨道快速转移的C++实现/image05-案例生成文件.png)

使用 ATK 软件打开想定文件，快速转移轨道如下图所示。

![快速转移轨道](../../zh/综合案例/media/轨道快速转移的C++实现/image06-快速转移轨道.png)
...
![数据报告文件位置](../../zh/综合案例/media/轨道快速转移的C++实现/image08-数据报告文件位置.png)

可输出卫星位置速度变化过程，如下图：

![卫星位置速度变化过程](../../zh/综合案例/media/轨道快速转移的C++实现/image09-卫星位置速度变化过程.png)

保存想定后，本案例生成 FastTransfer.atk 想定文件；启动 ATK 软件，打开生成的想定文件 FastTransfer.atk，三维展示卫星快速转移轨迹如下图：

![卫星快速转移轨迹三维展示](../../zh/综合案例/media/轨道快速转移的C++实现/image10-卫星快速转移轨迹三维展示.png)
...
![附加库目录设置](../../zh/综合案例/media/轨道快速转移的C++实现/image20-附加库目录添加.png)

![附加依赖项设置](../../zh/综合案例/media/轨道快速转移的C++实现/image21-附加依赖项添加.png)

6. **配置动态库文件和辅助数据文件**

推荐将 "Test" 项目配置选择为 `Release` 模式，右键单击 "Test" 项目 -> <kbd>生成</kbd>，此时终端将输出生成成功标志：

![生成可执行文件](../../zh/综合案例/media/轨道快速转移的C++实现/image22-生成可执行文件.png)

右键单击 "Test" 项目 -> <kbd>在文件资源管理器中打开</kbd>，进入 "Test" 工程根目录。此时工程根目录结构如下图所示：

![工程根目录结构](../../zh/综合案例/media/轨道快速转移的C++实现/image23-工程根目录结构.png)
...
![最终工程根目录结构](../../zh/综合案例/media/轨道快速转移的C++实现/image24-最终工程根目录结构.png)
