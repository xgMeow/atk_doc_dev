...
declare const offlineBundler: (options?: WebpackBundlerOptions) => Bundler;

export { type LessLoaderOptions, type LoaderOptions, type PostcssLoaderOptions, type SassLoaderOptions, type StylePreprocessorOptions, type StylusLoaderOptions, type WebpackBundlerOptions, offlineBundler as default, offlineBundler };
