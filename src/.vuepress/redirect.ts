export default {
    ...
    config:{ 
        ...
        "/topics/Attitude/AttitudeFixedInAxes":               "/zh/03-基础使用指南/03-对象管理/07-姿态定义/1-固定姿态.html",
        "/topics/Attitude/AttitudeFixedInCBF":                "/zh/03-基础使用指南/03-对象管理/07-姿态定义/2-固定于天体固定系姿态.html",
        "/topics/Attitude/AttitudeFixedInCBI":                "/zh/03-基础使用指南/03-对象管理/07-姿态定义/3-固定于天体惯性系姿态.html",
        "/topics/Attitude/AttitudeAlignedConstrained":        "/zh/03-基础使用指南/03-对象管理/07-姿态定义/4-对齐约束姿态.html",
        "/topics/Attitude/AttitudeMutilSegment":              "/zh/03-基础使用指南/03-对象管理/07-姿态定义/5-多分段姿态.html",
        "/topics/Attitude/AttitudeRealTime":                  "/zh/03-基础使用指南/03-对象管理/07-姿态定义/6-实时姿态.html",
        "/topics/Attitude/AttitudeSTKAttitude":               "/zh/03-基础使用指南/03-对象管理/07-姿态定义/7-STK文件姿态.html",
        "/topics/Attitude/AttitudeSpinning":                  "/zh/03-基础使用指南/03-对象管理/07-姿态定义/9-旋转姿态.html",
        "/topics/Attitude/AttitudeTargetPointing":            "/zh/03-基础使用指南/03-对象管理/07-姿态定义/10-目标指向姿态.html",
        "/topics/Attitude/AttitudeVVLHCBI":                   "/zh/03-基础使用指南/03-对象管理/07-姿态定义/12-惯性系VVLH姿态.html",
        "/topics/Attitude/AttitudeVVLHCBF":                   "/zh/03-基础使用指南/03-对象管理/07-姿态定义/13-固连系VVLH姿态.html",
        "/topics/Attitude/AttitudeEcfAligndVel":              "/zh/03-基础使用指南/03-对象管理/07-姿态定义/15-ECF对速度定向.html",
        "/topics/Attitude/AttitudeEciAligndVel":              "/zh/03-基础使用指南/03-对象管理/07-姿态定义/16-ECI对速度定向.html"
    }
}