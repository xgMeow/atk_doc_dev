...
![MagicDraw 安装向导界面](./media/2-相关软件部署过程/image1.png)
...
![复制插件到 plugins 目录](./media/2-相关软件部署过程/image2.png)

3. 启动 MagicDraw，在菜单栏中选择 `Options` -> `Environment` -> `Plugins`，确认插件已成功加载。

验证界面示例如下：

![确认插件安装成功界面](./media/2-相关软件部署过程/image3.png)
...
![复制插件到 plugins 目录](./media/2-相关软件部署过程/image2-1776129750019-12.png)