...
如果没有引言内容，不生成 `0-二级标题.md`。

## 文件命名规则

1. 文件和目录名前添加源文件中出现顺序编号：
   - 根级二级分组：`1-Define.md`、`2-Graphics/`
   - 子命令：`1-Graphics SetColor.md`、`2-Graphics Show.md`
2. 文件名使用标题文本。
3. 替换 Windows/路径非法字符：`\\ / : * ? " < > |` 替换为空格。
4. 合并连续空白并去掉首尾空白。
5. 保留中文、英文、空格和下划线等合法字符。
